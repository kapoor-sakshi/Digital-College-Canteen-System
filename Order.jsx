...
const Order = () => {
  ...
  return (
    <div className="bg-black lg:p-8 flex-1 lg:mt-0 mt-5  lg:max-w-[70%] xl:max-w-none flex flex-col justify-center">
      <Title addClass="text-[40px] text-white">Orders</Title>
        ...
        <table className="w-full text-sm text-center text-gray-300">
          <thead className="text-xs text-gray-400 uppercase bg-gray-700">
            <tr>
              ...
              <th scope="col" className="py-3">EXTRAS</th>
