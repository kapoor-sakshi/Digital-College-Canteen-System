...
import AdminFeedback from "../../components/admin/AdminFeedback"; // ✅ Newly added
...
const Profile = () => {
  ...
  return (
    <div className="flex px-10 min-h-[calc(100vh_-_433px)] lg:flex-row flex-col lg:mb-0 mb-10 bg-black text-white">
      <div className="lg:w-80 w-100 flex-shrink-0 lg:h-[100vh] justify-center flex flex-col border-l-2 border-r-4 shadow-2xl">
        ...
        <ul className="text-center font-semibold">
          ...
          >
            ...
            <button className="ml-1">Feedback</button>
          </li>
          <li
            className={`border w-full p-3 cursor-pointer hover:bg-primary hover:text-white transition-all ${tabs === 5 && "bg-primary text-white"}`}
            onClick={() => setTabs(5)}
          >
            <i className="fa fa-chart-pie"></i>
            <button className="ml-1">Sales</button>
          </li>
          <li
